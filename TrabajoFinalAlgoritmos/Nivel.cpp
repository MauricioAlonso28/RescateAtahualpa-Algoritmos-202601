...
void Nivel::dibujarTodo(Graphics^ g) {
	...
	//Codigo solo para ver el camino que estamos creando, desactivamos en config.h de la constante mostrar corredores
...
bool Nivel::verificarObjetosCompletos() {
	...
	for (size_t i = 0; i < objetos.size(); i++) {
		...
		// El bonus de vida no cuenta para completar el nivel
